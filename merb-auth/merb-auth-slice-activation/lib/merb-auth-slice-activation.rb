if defined?(Merb::Plugins)
  ...
  module MerbAuthSliceActivation
    ...
    # Slice metadata
    self.description = "MerbAuthSliceActivation is a chunky Merb slice!"
    self.version = "0.0.1"
    ...
    def self.setup_router(scope)
      ...
      # the slice is mounted at /merb-auth-slice-activation - note that it comes before default_routes
